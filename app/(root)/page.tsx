  ...
  return (
    <>
      <main className="flex-1 bg-[#0066FF] text-white">
        {/* Header Fixo */}
        <div className="sticky top-0 z-40 flex flex-col items-center justify-center gap-4 bg-[#0066FF] px-4 py-4 md:py-8 border-b border-white">
          <h2 className="text-center text-lg font-bold leading-tight md:text-2xl">
            🏠 <strong className="text-white">Revolucione sua Gestão Imobiliária com o VOUZ CRM!</strong>
          </h2>
        ...
        <section className="flex flex-col items-center justify-center gap-6 bg-white px-4 py-6 text-[#0066FF] md:py-8">
          <div className="bg-[#0066FF] p-8 rounded-3xl">
            <h1 className="text-6xl font-bold text-white text-center">VOUZ</h1>
            <p className="text-2xl font-bold text-white text-center">CRM imobiliário</p>
          </div>
          <h2 className="max-w-4xl px-4 text-center text-base font-normal leading-tight md:text-[1.5rem]">
            ...
            <strong className="text-[#0066FF]">
              Gerencie seus clientes imobiliários de forma inteligente e multiplique seus resultados!
            </strong>
          </h2>

          <h2 className="text-center text-xs md:text-[1.25rem]">
            CRM completo para corretores e imobiliárias que querem crescer de verdade!
          </h2>
        ...
        <section className="flex items-center justify-center bg-[#0066FF] px-4 py-6 border-t border-white">
          <div className="flex max-w-[78.125rem] flex-col gap-4 md:flex-row md:gap-8">
            <div className="flex flex-col items-center gap-4 text-center md:space-y-6">
              <h2 className="text-lg font-bold leading-tight md:text-xl text-white">
                Você tem ideia do trabalho que dá para gerenciar clientes imobiliários sem um CRM profissional?
              </h2>

              <p className="leading-tight text-white">
                Imagine perder vendas por não fazer follow-up, não saber qual cliente está mais próximo de comprar, não
                ter controle sobre seu funil de vendas imobiliário... Essa realidade pode custar milhares em oportunidades perdidas.
              </p>

              <h2 className="text-lg font-bold leading-tight md:text-xl">
                <strong className="text-white">Nossas Funcionalidades</strong> - O CRM mais completo e intuitivo para
                corretores e imobiliárias do Brasil.
              </h2>

              <p className="leading-tight text-white">
                1- Dashboard inteligente com visão 360° dos seus clientes e pipeline de vendas imobiliário.
              </p>
              <Image
                unoptimized
                draggable={false}
              ...
              <p className="leading-tight text-white">
                3- Gestão completa de corretores imobiliários de forma simples e eficiente.
              </p>
              <Image
                priority
                src="/corretor.png"
        ...
        {/* Seção Depoimentos */}
        <section className="flex items-center justify-center bg-white px-4 py-6 md:py-12 border-t-2 border-[#0066FF]">
          <div className="flex max-w-[78.125rem] flex-col items-center justify-center gap-4 md:gap-8">
            <h2 className="text-balance text-lg font-bold leading-tight md:text-2xl text-[#0066FF]">
              DEPOIMENTOS DE CORRETORES E IMOBILIÁRIAS QUE JÁ USAM O VOUZ CRM
            </h2>

            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              {/* Depoimento 1 */}
              <div className="rounded-lg bg-[#0066FF] p-6 text-white border-2 border-[#0066FF]">
                <div className="mb-4 flex flex-col items-center">
                  <h4 className="font-bold">CARLOS CORRETOR</h4>
                  <p className="text-sm text-gray-200">CORRETOR SENIOR - IMOBILIÁRIA EXCLUSIVA</p>
                ...
                <p className="text-center text-sm">
                  &quot;O VOUZ CRM TRANSFORMOU MINHA OPERAÇÃO DE VENDAS! AUMENTEI MINHA CONVERSÃO EM 65% E NUNCA MAIS
                  PERDI UM LEAD POR FALTA DE FOLLOW-UP. SIMPLESMENTE REVOLUCIONÁRIO!&quot;
                </p>
              </div>
              ...
              <div className="rounded-lg bg-[#0066FF] p-6 text-white border-2 border-[#0066FF]">
                <div className="mb-4 flex flex-col items-center">
                  ...
                  <p className="text-sm text-gray-200">DIRETORA - IMOBILIÁRIA INOVACORP</p>
                  <div className="mt-1 flex">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star key={star} className="h-4 w-4 fill-yellow-500 text-yellow-500" />
                    ))}
                ...
                <p className="text-center text-sm">
                  &quot;SISTEMA INCRÍVEL! NOSSA EQUIPE DE CORRETORES TRIPLICOU A PRODUTIVIDADE. OS RELATÓRIOS SÃO
              ...
              <div className="rounded-lg bg-[#0066FF] p-6 text-white border-2 border-[#0066FF]">
                <div className="mb-4 flex flex-col items-center">
                  ...
                  <p className="text-sm text-gray-200">FUNDADOR - IMOBILIÁRIA DIGITAL</p>
                  <div className="mt-1 flex">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star key={star} className="h-4 w-4 fill-yellow-500 text-yellow-500" />
                    ))}
                ...
                <p className="text-center text-sm">
                  &quot;DESDE QUE IMPLEMENTAMOS O VOUZ CRM, NOSSA RECEITA CRESCEU 120% EM 6 MESES. A ORGANIZAÇÃO DOS
              ...
              <div className="rounded-lg bg-[#0066FF] p-6 text-white border-2 border-[#0066FF]">
                <div className="mb-4 flex flex-col items-center">
                  ...
                  <p className="text-sm text-gray-200">CMO - IMOBILIÁRIA GROWTH</p>
                  <div className="mt-1 flex">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star key={star} className="h-4 w-4 fill-yellow-500 text-yellow-500" />
                    ))}
                ...
                <p className="text-center text-sm">
                  &quot;MELHOR INVESTIMENTO QUE FIZEMOS! O VOUZ CRM É INTUITIVO, PODEROSO E O SUPORTE É EXCEPCIONAL.
            ...
            <div className="flex flex-col items-center gap-4 md:flex-row md:gap-8">
              <div className="space-y-4 text-center md:space-y-6">
                <h2 className="text-balance text-lg font-bold leading-tight md:text-2xl text-[#0066FF]">
                  O ÚNICO CRM imobiliário brasileiro com PREÇO JUSTO e funcionalidades de NÍVEL ENTERPRISE.
                </h2>
                <p className="leading-tight text-[#0066FF]">
                  Com o VOUZ CRM você vai organizar seus clientes imobiliários profissionalmente, automatizar vendas, nunca mais
                  perder oportunidades e multiplicar seus resultados.
                </p>
                <p className="leading-tight text-[#0066FF]">
                  Além de <strong>ESCALAR SEU NEGÓCIO IMOBILIÁRIO</strong> com inteligência artificial integrada!
                </p>
              </div>
            </div>
            ...
            <div className="mx-auto w-full space-y-4 py-4 md:space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
                <div className="flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-green-600 bg-green-100 p-6 text-center text-green-600">
                  ...
                  <p className="font-bold">Terá controle total sobre seu pipeline de vendas imobiliário</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-green-600 bg-green-100 p-6 text-center text-green-600">
                  <IoIosCheckmarkCircle className="size-8" />
                  <p className="font-bold">Poderá automatizar follow-ups e nutrir leads imobiliários</p>
                </div>
                <div className="flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-green-600 bg-green-100 p-6 text-center text-green-600">
                  <IoIosCheckmarkCircle className="size-8" />
            ...
            <p className="py-2 text-center leading-tight text-[#0066FF]">
              Esse é o jeito mais INTELIGENTE e EFICIENTE de gerenciar seus clientes imobiliários!
            </p>
          </div>
        </section>
      </main>
